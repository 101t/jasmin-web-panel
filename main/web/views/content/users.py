        ...
        if users:
            if s == "list":
                ...
                try:
                    ...
                    resstatus, resmessage = 200, _("User added successfully!")
                ...
                try:
                    ...
                    resstatus, resmessage = 200, _("User edited successfully!")
                except Exception as e:
                    resmessage = e
            elif s == "delete":
                args = users.destroy(uid=request.POST.get("uid"))
                resstatus, resmessage = 200, _("User deleted successfully!")
            elif s == "enable":
                args = users.enable(uid=request.POST.get("uid"))
                resstatus, resmessage = 200, _("User enabled successfully!")
            elif s == "disable":
                args = users.disable(uid=request.POST.get("uid"))
                resstatus, resmessage = 200, _("User disabled successfully!")
            elif s == "smpp_unbind":
                args = users.smpp_unbind(uid=request.POST.get("uid"))
                resstatus, resmessage = 200, _("User SMPP Unbind successfully!")
            elif s == "smpp_ban":
                args = users.smpp_ban(uid=request.POST.get("uid"))
                resstatus, resmessage = 200, _("User SMPP Ban successfully!")
